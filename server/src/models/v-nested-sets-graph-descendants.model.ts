...
@model({"settings":{"idInjection":false,"postgresql":{"schema":"public","table":"v_nested_sets_graph_descendants"}}})
export class VNestedSetsGraphDescendants extends Entity {
  @property({
    type: Number,
    required: false,
    scale: 0,
  ...
  constructor(data?: Partial<VNestedSetsGraphDescendants>) {
    super(data);
  }
}
